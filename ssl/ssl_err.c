...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_FINAL_TLMSP, 0), "final_tlmsp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_FINAL_TLMSP_CONTEXT_LIST, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CHANGE_CIPHER_STATE, 0),
     "tlmsp_change_cipher_state"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CHECK_READER_MAC, 0),
     "tlmsp_check_reader_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONSTRUCT_CTOS_TLMSP, 0),
     "tlmsp_construct_ctos_tlmsp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONSTRUCT_CTOS_TLMSP_CONTEXT_LIST, 0),
     "tlmsp_construct_ctos_tlmsp_context_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONSTRUCT_KEY_MATERIAL_CONTRIBUTION, 0),
     "tlmsp_construct_key_material_contribution"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONSTRUCT_MIDDLEBOX_CERT, 0),
     "tlmsp_construct_middlebox_cert"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONSTRUCT_MIDDLEBOX_FINISHED, 0),
     "tlmsp_construct_middlebox_finished"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONSTRUCT_MIDDLEBOX_HELLO, 0),
     "tlmsp_construct_middlebox_hello"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONSTRUCT_MIDDLEBOX_KEY_CONFIRMATION, 0),
     "tlmsp_construct_middlebox_key_confirmation"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONSTRUCT_MIDDLEBOX_KEY_EXCHANGE, 0),
     "tlmsp_construct_middlebox_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONSTRUCT_MIDDLEBOX_KEY_MATERIAL, 0),
     "tlmsp_construct_middlebox_key_material"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONSTRUCT_SERVER_KEY_EXCHANGE, 0),
     "tlmsp_construct_server_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONSTRUCT_STOC_TLMSP, 0),
     "tlmsp_construct_stoc_tlmsp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONTAINER_CHECK_MAC, 0),
     "tlmsp_container_check_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONTAINER_DELIVER_ALERT, 0),
     "TLMSP_container_deliver_alert"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONTAINER_ENC, 0),
     "tlmsp_container_enc"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONTAINER_FORWARDING_MAC, 0),
     "tlmsp_container_forwarding_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONTAINER_MAC, 0),
     "tlmsp_container_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONTAINER_PARSE, 0),
     "tlmsp_container_parse"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONTAINER_READ, 0),
     "TLMSP_container_read"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONTAINER_READER_CHECK_MAC, 0),
     "tlmsp_container_reader_check_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONTAINER_WRITE, 0),
     "TLMSP_container_write"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_CONTEXT_ACCESS_ADD, 0),
     "TLMSP_context_access_add"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_DERIVE_KEYS, 0), "tlmsp_derive_keys"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_DIGEST_CERTIFICATE, 0),
     "tlmsp_digest_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_ENC, 0), "tlmsp_enc"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_GENERATE_MASTER_SECRET, 0),
     "tlmsp_generate_master_secret"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_GENERATE_MIDDLEBOX_MASTER_SECRET, 0),
     "tlmsp_generate_middlebox_master_secret"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_GET_MIDDLEBOXES_INSTANCE, 0),
     "TLMSP_get_middleboxes_instance"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_GET_MIDDLEBOXES_LIST, 0),
     "tlmsp_get_middleboxes_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_GET_RECONNECT_STATE, 0),
     "TLMSP_get_reconnect_state"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_HASH_IDLIST, 0), "tlmsp_hash_idlist"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_KEY_ACTIVATE_ALL, 0),
     "tlmsp_key_activate_all"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MAC, 0), "tlmsp_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MAC_INPUT, 0), "tlmsp_mac_input"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_ADD, 0),
     "TLMSP_middlebox_add"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_COPY, 0),
     "tlmsp_middlebox_copy"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_CREATE, 0),
     "tlmsp_middlebox_create"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_DUP, 0),
     "tlmsp_middlebox_dup"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_DUP_STATIC, 0),
     "tlmsp_middlebox_dup_static"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_HANDSHAKE_PROCESS, 0),
     "tlmsp_middlebox_handshake_process"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_INSTANCE_COPY, 0),
     "tlmsp_middlebox_instance_copy"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_INSTANCE_DUP, 0),
     "tlmsp_middlebox_instance_dup"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_PARSE_CTOS_SIG_ALGS, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_PROCESS_MIDDLEBOX_FINISHED, 0),
     "tlmsp_middlebox_process_middlebox_finished"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_PROCESS_MIDDLEBOX_HELLO, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_PROCESS_MIDDLEBOX_KEY_MATERIAL, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_SEND_MIDDLEBOX_KEY_CONFIRMATION, 0),
     "tlmsp_middlebox_send_middlebox_key_confirmation"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_MIDDLEBOX_VERIFY_CERTIFICATE, 0),
     "tlmsp_middlebox_verify_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PARSE_CONTEXT_LIST, 0),
     "tlmsp_parse_context_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PARSE_CTOS_TLMSP, 0),
     "tlmsp_parse_ctos_tlmsp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PARSE_CTOS_TLMSP_CONTEXT_LIST, 0),
     "tlmsp_parse_ctos_tlmsp_context_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PARSE_MIDDLEBOX_LIST, 0),
     "tlmsp_parse_middlebox_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PARSE_STOC_TLMSP, 0),
     "tlmsp_parse_stoc_tlmsp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_ALERT, 0),
     "tlmsp_process_alert"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_CERTIFICATE, 0),
     "tlmsp_process_certificate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_CLIENT_KEY_EXCHANGE, 0),
     "tlmsp_process_client_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_KEY_MATERIAL_CONTRIBUTION, 0),
     "tlmsp_process_key_material_contribution"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_MIDDLEBOX_CERT, 0),
     "tlmsp_process_middlebox_cert"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_MIDDLEBOX_FINISHED, 0),
     "tlmsp_process_middlebox_finished"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_MIDDLEBOX_HELLO, 0),
     "tlmsp_process_middlebox_hello"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_MIDDLEBOX_HELLO_DONE, 0),
     "tlmsp_process_middlebox_hello_done"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_MIDDLEBOX_KEY_CONFIRMATION, 0),
     "tlmsp_process_middlebox_key_confirmation"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_MIDDLEBOX_KEY_EXCHANGE, 0),
     "tlmsp_process_middlebox_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_MIDDLEBOX_KEY_MATERIAL, 0),
     "tlmsp_process_middlebox_key_material"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_PROCESS_SERVER_KEY_EXCHANGE, 0),
     "tlmsp_process_server_key_exchange"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_READ_BYTES, 0), "tlmsp_read_bytes"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_READ_CONTAINER, 0),
     "tlmsp_read_container"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_READ_FORWARDING_MAC, 0),
     "tlmsp_read_forwarding_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_READ_FORWARDING_MACS, 0),
     "tlmsp_read_forwarding_macs"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_READ_FRAGMENT, 0),
     "tlmsp_read_fragment"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_READ_M_INFO, 0), "tlmsp_read_m_info"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_READ_WRITER_MAC, 0),
     "tlmsp_read_writer_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_RECORD_ENC, 0), "tlmsp_record_enc"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_RECORD_MAC, 0), "tlmsp_record_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_RESET_CIPHER, 0), "tlmsp_reset_cipher"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_SETUP_ADVANCE_KEYS, 0),
     "tlmsp_setup_advance_keys"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_SETUP_KEY_BLOCK, 0),
     "tlmsp_setup_key_block"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_VERIFY_FORWARDING_CHECK_MAC, 0),
     "tlmsp_verify_forwarding_check_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_VERIFY_FORWARDING_READER_MAC, 0),
     "tlmsp_verify_forwarding_reader_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_VERIFY_READER_MAC, 0),
     "tlmsp_verify_reader_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_WRITE_BYTES, 0), "tlmsp_write_bytes"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_WRITE_FORWARDING_MAC, 0),
     "tlmsp_write_forwarding_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_WRITE_FORWARDING_MACS, 0),
     "tlmsp_write_forwarding_macs"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_WRITE_FRAGMENT, 0),
     "tlmsp_write_fragment"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLMSP_WRITE_WRITER_MAC, 0),
     "tlmsp_write_writer_mac"},
...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    "digest check failed"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_DISCOVERY_RECONNECT),
    "discovery reconnect"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_TLMSP_ALERT_AUTHENTICATION_REQUIRED),
    "tlmsp alert authentication required"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_TLMSP_ALERT_BAD_READER_MAC),
    "tlmsp alert bad reader mac"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_TLMSP_ALERT_BAD_WRITER_MAC),
    "tlmsp alert bad writer mac"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_TLMSP_ALERT_DISCOVERY_ACK),
    "tlmsp alert discovery ack"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_TLMSP_ALERT_MIDDLEBOX_AUTHORIZATION_FAILURE),
    "tlmsp alert middlebox authorization failure"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_TLMSP_ALERT_MIDDLEBOX_KEYCONFIRMATION_FAULT),
    "tlmsp alert middlebox keyconfirmation fault"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_TLMSP_ALERT_MIDDLEBOX_KEY_VERIFY_FAILURE),
    "tlmsp alert middlebox key verify failure"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_TLMSP_ALERT_MIDDLEBOX_REQUIRED),
    "tlmsp alert middlebox required"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_TLMSP_ALERT_MIDDLEBOX_ROUTE_FAILURE),
    "tlmsp alert middlebox route failure"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_TLMSP_ALERT_UNKNOWN_CONTEXT),
    "tlmsp alert unknown context"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_TLMSP_ALERT_UNSUPPORTED_CONTEXT),
    "tlmsp alert unsupported context"},
